...
filteredMovies = curGenre == "All Genres" ? favourites : favourites.filter((movie)=>genreids[movie.genre_ids[0]]==curGenre)
  ...
  <div className='text-center'>
    <input type="text" value={search} onChange={(e)=>setSearch(e.target.value)} placeholder='Search' className='border border-2
    text-center p-1 m-2'/>
     <input type="number" value={rows} onChange={(e)=>setRows(e.target.value)} placeholder='Rows' className='border border-2
    text-center p-1 m-2'/>
  </div>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  >
                    <div className='flex'>
                    <img src="https://img.icons8.com/material-rounded/50/000000/circled-chevron-up.png" className='mr-2 cursor-pointer'
                    onClick={()=>{
                      setpopularity(0)
                      setRating(-1)
                    }}/>
                    Rating
                    <img src="https://img.icons8.com/material-rounded/50/000000/circled-chevron-down.png" className='ml-2 mr-2'
                    onClick={()=>{
                      setpopularity(0)
                      setRating(1)
                    }}/>
